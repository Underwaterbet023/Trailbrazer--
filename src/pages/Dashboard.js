    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {shoppingConfirmed && (
        <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4 flex items-center">
          ...
          <div>
            <h3 className="text-green-800 font-semibold">Shopping Confirmed!</h3>
            <p className="text-green-700 text-sm">Your payment was successful and your booking has been confirmed.</p>
          </div>
        </div>
      )}
