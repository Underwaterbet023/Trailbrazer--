        ...
        (error) => {
          ...
          switch(error.code) {
            case error.PERMISSION_DENIED:
              errorMessage += "Please allow location access in your browser settings to enable live tracking.";
              break;
            ...
            case error.TIMEOUT:
              ...
              break;
            default:
              errorMessage += "Using default location for tracking.";
          }
          alert(errorMessage);
          // Use a default location to still show the map functionality
          const defaultLocation = [20.5937, 78.9629]; // Center of India
          setCurrentPosition(defaultLocation);
          generateSimulatedRoute(defaultLocation, selectedTrip);
        },
